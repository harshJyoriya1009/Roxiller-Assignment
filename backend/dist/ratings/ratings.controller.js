...
const ratings_dto_1 = require("./ratings.dto");
...
let RatingsController = class RatingsController {
    ...
    async create(user, createRatingDto) {
        return this.ratingsService.create(user.id, createRatingDto);
    }
    async update(user, id, updateRatingDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, ratings_dto_1.CreateRatingDto]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, ratings_dto_1.UpdateRatingDto]),
    __metadata("design:returntype", Promise)
